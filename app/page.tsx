...
const copy = {
  de: {
    chapters:['Begrenzung','Lösen','Kontext','Unternehmen','Atelier','Erkenntnis'], skip:'Direkt zur Experience', subtitle:'Bewegung aus Stoff', sources:'Quellen', sound:['Sound aus','Sound an'],
  ...
  en: {
    chapters:['Restriction','Release','Context','Enterprise','Studio','Insight'], skip:'Skip to the experience', subtitle:'Movement through fabric', sources:'Sources', sound:['Sound off','Sound on'],
