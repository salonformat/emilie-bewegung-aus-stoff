...
const copy = {
  de: {
    ...
    businessEye:'Schwestern Flöge · Wien', businessTitle:['Gestalten hieß auch','entscheiden.'], businessLead:'Emilie Flöge führte den Modesalon gemeinsam mit ihren Schwestern Helene und Pauline. Übernimm eine Rolle im Salon und entdecke, was hinter einem Kleid noch alles stand.', businessTasks:[['Entwerfen','Du entwickelst eine neue Silhouette – mit Blick auf Stoff, Kundin und Bewegungsfreiheit.'],['Auswählen','Du beurteilst Textilien, Qualität und internationale Einflüsse für den Salon.'],['Verantworten','Du koordinierst Aufträge, berätst Kundinnen und führst Mitarbeiterinnen.']], businessResult:['Du verbindest eine gestalterische Idee mit den Bedürfnissen eines bewegten Körpers.','Du entscheidest, welche Materialien und neuen Einflüsse Teil der Kollektion werden.','Du hältst Gestaltung, Kundinnen und den Arbeitsalltag des Salons zusammen.'], businessLearning:'Flöges Arbeit bestand nicht nur aus Entwerfen. Kreativität, wirtschaftliche Entscheidungen und Führung gehörten zusammen.', chooseTask:'Welche Rolle übernimmst du im Salon?', reveal:'Deine Entscheidung', turnAgain:'Andere Rolle wählen', continueAtelier:'Weiter ins digitale Modeatelier',
  ...
  en: {
    ...
    businessEye:'Schwestern Flöge · Vienna', businessTitle:['Design also meant','deciding.'], businessLead:'Emilie Flöge ran the fashion salon together with her sisters Helene and Pauline. Take on a role in the salon and discover everything that stood behind a dress.', businessTasks:[['Design','You develop a new silhouette with fabric, client, and freedom of movement in mind.'],['Select','You assess textiles, quality, and international influences for the salon.'],['Lead','You coordinate commissions, advise clients, and manage employees.']], businessResult:['You connect a creative idea with the needs of a moving body.','You decide which materials and new influences become part of the collection.','You hold together design, clients, and the salon’s working day.'], businessLearning:'Flöge’s work extended beyond designing. Creativity, commercial decisions, and leadership belonged together.', chooseTask:'Which role will you take in the salon?', reveal:'Your decision', turnAgain:'Choose another role', continueAtelier:'Continue to the digital fashion studio',
...
export default function Home() {
  ...
  return (
    <main className={`experience-shell chapter-${chapter} ${released ? 'is-released' : ''}`}>
